          ...
          <table class="responsive-table">
            ...
            <tbody>
              <tr v-for="atividade of atividades" :key="atividade.id">
                ...
                <td><button class=" waves-effect waves-light btn-small" @click="verFiles(atividade)">Iniciar Atividade</button></td>
                <td><button type="reset" class="waves-effect red waves-light btn-small" @click="excluirAtv(atividade)">Excluir atividade<i class="material-icons left">delete</i></button></td>
